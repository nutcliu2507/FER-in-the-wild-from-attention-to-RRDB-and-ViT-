...
def run_model():
    ...
    black.summary()
    black.compile(optimizer=Adam(learning_rate = 0.0001), loss=[Focalloss, categorical_crossentropy],loss_weights=[0.7, 0.3], metrics=['accuracy'])
